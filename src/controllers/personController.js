...
module.exports = {
    ...
    assignService: async  (req, res) => {
        const idUser = req.params.idUser
        const idService = req.params.idService
    
        await userModel.assignServiceToPerson(idUser, idService)
        console.log(idUser, idService)
        res.json('Serviço atribuito ao usuario com sucesso!')
    },
    removeAssignment: async  (req, res) => {
        const idUser = req.params.idUser
        const idService = req.params.idService
    
        await userModel.removeAssignment(idUser, idService)
        console.log('controller: ', idUser, idService)
        res.json('Serviço removido ao usuario com sucesso!')
    },
    ...
    disactivateDependent: async  (req, res) => {
        try {
            const id = req.query.id;
    ...
    getList: async  (page, limit, active) => {
        try {
