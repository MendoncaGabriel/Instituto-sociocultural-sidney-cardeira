...
router.post('/addNewDependent/:id',  upload.single('image'), userController.addNewDependent)
router.patch('/updateDependentData/:id',  upload.single('image'), userController.updateDependentData)
